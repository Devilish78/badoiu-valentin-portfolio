...
class HeroAnimations {
  constructor() {
    ...
    this.rotatingPhrases = [
      "crafts with accessibility as a priority",
      "creates AI-enhanced digital masterpieces",
      "builds innovative web experiences",
      "transforms ideas into digital reality",
      "specializes in creative development",
      "brings imagination to life through code",
      "a loving father of two amazing kids and deeply in love with his wife",
      "believes technology should be wild and human",
      "explores gardens, 3D art, and timeless ideas"
    ];
